...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-03-2026 a las 20:47:47
...
--
ALTER TABLE `detalle_asignacion`
  MODIFY `id_detalle_asig` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=414;

--
-- AUTO_INCREMENT de la tabla `detalle_deduccion`
--
ALTER TABLE `detalle_deduccion`
  MODIFY `id_detalle_ded` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=347;
...
--
ALTER TABLE `nomina`
  MODIFY `id_nomina` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
